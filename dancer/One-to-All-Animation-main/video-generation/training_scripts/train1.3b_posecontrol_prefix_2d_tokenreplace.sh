...
OUTPUT_DIR="outputs_wanx1.3b/train1.3b_posecontrol_prefix_2d_tokenreplace"
mkdir -p ${OUTPUT_DIR}

LOG_FILE="${OUTPUT_DIR}/train1.3b_posecontrol_prefix_2d_tokenreplace.log"

echo "=========================================="
echo "  Training Wan2.1-1.3B with Pose Control & Token Replace"
echo "=========================================="
...
accelerate launch \
      ...
      --pretrained ./outputs_wanx1.3b/train1.3b_posecontrol_prefix_2d/checkpoint-xxx/fp32_model_xxx \
