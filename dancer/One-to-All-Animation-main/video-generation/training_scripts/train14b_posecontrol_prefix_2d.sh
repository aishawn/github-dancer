...
OUTPUT_DIR="outputs_wanx14b/train14b_posecontrol_prefix_2d"
mkdir -p ${OUTPUT_DIR}

LOG_FILE="${OUTPUT_DIR}/train14b_posecontrol_prefix_2d.log"

echo "=========================================="
echo "  Training Wan2.1-14B with Pose Control"
echo "=========================================="
...
accelerate launch \
      ...
      --pretrained ./outputs_wanx14b/train14b_only_refextractor_2d/checkpoint-xxx/fp32_model_xxx \
