...
output_base_dir = "../output_benchmark/tiktok/One-to-All-14b"
MAIN_CHUNK = 81
OVERLAP_FRAMES = 5
...
def unified_worker(rank, world_size, task_list, ckpt_path):
    ...
    output_root = os.path.join(output_base_dir, current_date)
...
def run_all_tasks(ckpt_path, img_g, pose_g, cache_dir_root="input_cache"):
    ...
    task_list = [
        ("../benchmark/tiktok_test_set/000","../benchmark/tiktok_test_set/000_reference.png","ref","","","1.5","1.2"),
        ("../benchmark/tiktok_test_set/001","../benchmark/tiktok_test_set/001_reference.png","ref","","","1.5","1.2"),
        ("../benchmark/tiktok_test_set/002","../benchmark/tiktok_test_set/002_reference.png","ref","512","512","",""),
        ("../benchmark/tiktok_test_set/003","../benchmark/tiktok_test_set/003_reference.png","ref","","","2.0","1.2"),
        ("../benchmark/tiktok_test_set/004","../benchmark/tiktok_test_set/004_reference.png","ref","512","512","",""),
        ("../benchmark/tiktok_test_set/005","../benchmark/tiktok_test_set/005_reference.png","ref","512","512","",""),
        ("../benchmark/tiktok_test_set/006","../benchmark/tiktok_test_set/006_reference.png","ref","512","512","",""),
        ("../benchmark/tiktok_test_set/007","../benchmark/tiktok_test_set/007_reference.png","ref","","","2.0","1.2"),
        ("../benchmark/tiktok_test_set/008","../benchmark/tiktok_test_set/008_reference.png","ref","512","512","",""),
        ("../benchmark/tiktok_test_set/009","../benchmark/tiktok_test_set/009_reference.png","ref","","","",""),
    ]
